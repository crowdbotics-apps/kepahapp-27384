...
const Logo: React.FC<Props> = ({navigation, ...props}) => {
        ...
        <View style={{height: '90%'}}>
          <View
            ...
            <View
              ...
              <Text
                style={{fontSize: RFValue(18), fontWeight: 'bold', top: -15}}>
                Add Maintenance
              </Text>
              <Text
                style={{fontSize: RFValue(35), fontWeight: 'bold', top: 20}}>
                LOGO
              </Text>
            </View>
