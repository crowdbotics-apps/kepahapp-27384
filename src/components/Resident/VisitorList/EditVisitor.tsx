...
<View style={{height: '40%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                  <View
                    style={{
                      display: 'flex',
                      flexDirection: 'row',
                    ...
                    <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', top: 20}}>
                    <Text style={{color: '#2e1070' , textDecorationLine: 'underline'}}>Remove this Visitor</Text>
                  </View>
                  </View>
