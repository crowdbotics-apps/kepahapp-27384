...
const SecurityRepost: React.FC<Props> = ({navigation}) => {
      ...
      <View style={{height: '90%'}}>
        <View
          ...
          <View
            ...
            <Text style={{fontSize: RFValue(35), fontWeight: 'bold', top: 20, color: '#2e1070'}}>
              LOGO
            </Text>
          </View>
            ...
            <View
              ...
              <View
                ...
                <Text style={{fontSize: RFValue(18), marginTop: 10}}>
                  Request to link bank
                </Text>
                <Text style={{fontSize: RFValue(18)}}>account received. </Text>
                <View
                  style={{
                    borderWidth: 1,
                    width: 130,
